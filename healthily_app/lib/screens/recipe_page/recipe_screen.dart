...
import 'package:healthily_app/screens/recipe_page/recipe_card.dart';
import 'package:healthily_app/screens/recipe_page/recipe_modal.dart';
import 'package:healthily_app/screens/restaurants_page/restaurants_card.dart';

class Rec extends StatefulWidget {
  Rec(this.filteredRes, this.recipes, {super.key});
                ...
                child: Column(
                  children: [
                    Padding(
                      ...
                      child: Text(
                        widget.flag == 0 ? "Recipes" : "Restaurants",
